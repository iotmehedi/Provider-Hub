                    ...
                    children: [
                      ...
                      CustomElevatedButton(
                          text: CustomSimpleText(
                            ...
                            fontSize: 21,
                            color: controller.selectRegistrationOptions.value !=
                                    "0"
                                ? AppColors.appColors
                                : AppColors.white,
                          ),
                          onPress: () {
                            ...
                            RouteGenerator.pushNamed(
                                context, Routes.providerRegScreen);
                          },
                          backgroundColor:
                              controller.selectRegistrationOptions.value == "0"
                                  ? AppColors.appColors
                      ...
                      CustomElevatedButton(
                          ...
                          onPress: () {
                            ...
                            RouteGenerator.pushNamed(
                                context, Routes.trainerRegScreen);
                          },
                          backgroundColor:
                              controller.selectRegistrationOptions.value == "1"
                                  ? AppColors.appColors
                      ...
                      CustomElevatedButton(
                          ...
                          onPress: () {
                            ...
                            RouteGenerator.pushNamed(
                                context, Routes.consultantRegScreen);
                          },
                          backgroundColor:
                              controller.selectRegistrationOptions.value == "2"
                                  ? AppColors.appColors
